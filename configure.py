...
_DEFAULT_CUDA_COMPUTE_CAPABILITIES = '3.5,6.1,7.0,7.5'
...
def set_cc_opt_flags(environ_cp):
  ...
  if is_ppc64le():
    ...
    default_cc_opt_flags = '-march=westmere -Wno-sign-compare'
  ...
  if not is_ppc64le() and not is_windows():
    write_to_bazelrc('build:opt --host_copt=-march=westmere')
